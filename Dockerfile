...
RUN apt-get install -y wget gnupg2 software-properties-common linux-headers-$(uname -r)
...
RUN apt-get install -y cuda-11-6 cuda-cudart-11-6 cuda-cudart-dev-11-6 && \
